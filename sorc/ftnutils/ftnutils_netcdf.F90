! > @file sorc/ftnutils/ftnutils_netcdf.F90
...
module ftnutils_netcdf
    ...
    interface ncread
        ...
        module procedure read_arr2d_integer
        module procedure read_arr2d_single
        module procedure read_arr3d_double
        module procedure read_arr3d_integer
...
500     format("netCDF variable", 1x, a, 1x, "is datatype", 1x, i3, 1x, &
    ...
    ! > @brief Read an integer-type 1-dimensional variable array.
    ! !
    ! ! @params[inout] nccls
    ! !    - An initialized netCDF object.
    ! !
    ...
    ! > @brief Read an integer-type 2-dimensional variable array.
    ! !
    ! ! @params[inout] nccls
    ! !    - An initialized netCDF object.
    ! !
    ...
    ! ! @returns: varrar
    ! !    - The netCDF variable 2-dimensional array values.
    subroutine read_arr2d_integer(nccls, varname, vararr)
        class(ncdata), intent(inout) :: nccls
        character(len=maxchar), intent(in) :: varname
        integer(ilong), dimension(:, :), intent(out) :: vararr
        ...
        nccls%ncstatus = nf90_get_var(nccls%ncfileid, nccls%ncvarid, vararr)
        if (nccls%ncstatus /= 0) call ncerror(nccls = nccls)
    end subroutine read_arr2d_integer
    ...
    ! > @brief Read an integer-type 3-dimensional variable array.
    ! !
    ! ! @params[inout] nccls
    ! !    - An initialized netCDF object.
    ! !
    ...
    ! ! @returns varrar
    ! !    - The netCDF variable 3-dimensional array values.
    subroutine read_arr3d_integer(nccls, varname, vararr)
        class(ncdata), intent(inout) :: nccls
        character(len=maxchar), intent(in) :: varname
        integer(ilong), dimension(:, :, :), intent(out) :: vararr
        ...
        nccls%ncstatus = nf90_get_var(nccls%ncfileid, nccls%ncvarid, vararr)
        if (nccls%ncstatus /= 0) call ncerror(nccls = nccls)
    end subroutine read_arr3d_integer
    ...
    ! > @brief Read an integer-type scalar variable.
    ! !
    ! ! @params[inout] nccls
    ! !    - An initialized netCDF object.
    ! !
    ...
    ! ! @returns varrar
    ! !    - The netCDF variable value(s).
    subroutine read_scalar_integer(nccls, varname, vararr)
        class(ncdata), intent(inout) :: nccls
        character(len=maxchar), intent(in) :: varname
        integer(ilong), intent(out) :: vararr
